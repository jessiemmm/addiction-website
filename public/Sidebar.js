...
<div class="card">
  <div class="card-body">
    <h4 class="card-title">Treatment Facilities Nationwide</h4>
    ...
    <br>
    <a href="#" class="card-link">Sunrise Fields</a>
    <br>
    <a href="#" class="card-link">The Peaceful Project</a>
    <br>
    <a href="#" class="card-link">Mindful Meadows</a>
    <br>
    <a href="#" class="card-link">Winding Rivers</a>
  </div>
</div>
